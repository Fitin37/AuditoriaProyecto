...
namespace vistaa.GestioneNova
{
    public partial class FrmCitas : Form
    {
        ...
        public FrmCitas(bool soloLectura) : this() { btnNuevoCita.Visible=!soloLectura; btnEditarCitas.Visible=!soloLectura; btnEliminarCita.Visible=!soloLectura; }
        public FrmCitas() { InitializeComponent(); this.Load += FrmCitas_Load; }
        ...
        private void btnActualizarCita_Click(object sender, EventArgs e) { RefrescarGrid(); MessageBox.Show("Datos actualizados."); }
